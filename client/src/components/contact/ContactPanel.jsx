...
export function ContactPanel({ hotel }) {
  ...
  return (
    <FadeIn id="contact" as="section" className="relative z-10 border-t border-mist bg-[#f7f7f7]">
      <div className="container-page grid gap-6 py-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
        <div>
          <p className="eyebrow">Feedback and contact</p>
          <h2 className="mt-3 text-3xl font-bold leading-tight md:text-4xl">Share feedback with the hotel team.</h2>
